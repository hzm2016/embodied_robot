...
def _confirm_callback(vis):
 ...
 [[ 5.03585923e-01, -4.21313279e-01  ,7.54252172e-01 ,-1.89643755e+02],
 [-3.46350173e-01 , 7.01355128e-01 , 6.23010868e-01, -5.12523810e+02],
 [-7.91481381e-01 ,-5.74974873e-01 , 2.07270643e-01 , 8.21324768e+02],
...
if __name__ == "__main__":
 ...
 [ 0.00000000e+00  ,0.00000000e+00 , 0.00000000e+00 , 1.00000000e+00]]
    ...
    while True:
        ...
        joint_rad = joint
        joint_rad =np.array([0.29, 0.56, 0.57, 0.99, -0.16, 0.57, 0.89],dtype=float)
        T_base2ee = fk(joint_rad)
        # print("Joint angles (deg):", ["{:.2f}".format(a) for a in joint_rad])
